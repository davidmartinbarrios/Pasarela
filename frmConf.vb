...
procFin: 
	...
	Private Sub msCargarDatos()
		...
		While Not rst1.EOF
			...
			'UPGRADE_WARNING: Lower bound of collection lstProc.ListItems has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
			'UPGRADE_ISSUE: MSComctlLib.ListSubItems method lstProc.ListItems.ListSubItems.Add was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
			lstProc.Items.Item(lstProc.Items.Count).SubItems.Add(2,  , Trim(rst1.Fields("FECHA_ACTIVACION").Value) & "")
			'UPGRADE_WARNING: Lower bound of collection lstProc.ListItems has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
			'UPGRADE_ISSUE: MSComctlLib.ListSubItems method lstProc.ListItems.ListSubItems.Add was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
			lstProc.Items.Item(lstProc.Items.Count).SubItems.Add(3,  , IIf(Trim(rst1.Fields("NUEVA_VERSION").Value) = "1", "Si", "No") & "")
			'UPGRADE_WARNING: Lower bound of collection lstProc.ListItems has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
			'UPGRADE_ISSUE: MSComctlLib.ListSubItems method lstProc.ListItems.ListSubItems.Add was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
			lstProc.Items.Item(lstProc.Items.Count).SubItems.Add(4,  , Trim(rst1.Fields("BASEDATOS").Value) & "")
			'UPGRADE_WARNING: Lower bound of collection lstProc.ListItems has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
			'UPGRADE_ISSUE: MSComctlLib.ListSubItems method lstProc.ListItems.ListSubItems.Add was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
			lstProc.Items.Item(lstProc.Items.Count).SubItems.Add(5,  , Trim(rst1.Fields("CONEXION").Value) & "")
			'lstProc.ListItems(lstProc.ListItems.Count).ListSubItems.Add 6, , Trim(rst1("OBSERVACIONES")) & ""
			'UPGRADE_WARNING: Lower bound of collection lstProc.ListItems has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
			'UPGRADE_ISSUE: MSComctlLib.ListSubItems method lstProc.ListItems.ListSubItems.Add was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
			lstProc.Items.Item(lstProc.Items.Count).SubItems.Add(6,  , Trim(rst1.Fields("CONEXION2").Value) & "")
			'UPGRADE_WARNING: Lower bound of collection lstProc.ListItems has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
			'UPGRADE_ISSUE: MSComctlLib.ListSubItems method lstProc.ListItems.ListSubItems.Add was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
			lstProc.Items.Item(lstProc.Items.Count).SubItems.Add(7,  , Trim(rst1.Fields("OBSERVACIONES").Value) & "")
			rst1.MoveNext()
		End While
		GoTo procFin
